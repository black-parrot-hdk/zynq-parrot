...
proc init { cellpath otherInfo } {
    ...
    if {[get_bd_intf_port -quiet FIXED_IO] == {}} {
        make_bd_intf_pins_external -name "FIXED_IO" [get_bd_intf_pins ${cellpath}/FIXED_IO]
        make_bd_intf_pins_external -name "DDR" [get_bd_intf_pins ${cellpath}/DDR]
    }
}
...
proc vivado_create_ip { args } {
	...
	set_property -dict [list \
		...
		CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ $aclk_freq_mhz \
		CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ $rtclk_freq_mhz \
		CONFIG.PCW_USE_M_AXI_GP0 {1} \
		CONFIG.PCW_USE_M_AXI_GP1 {1} \
		CONFIG.PCW_USE_S_AXI_HP0 {1} \
	] $processing_system7_0
    apply_bd_automation -rule xilinx.com:bd_rule:processing_system7 -config {make_external "FIXED_IO, DDR" Master "Disable" Slave "Disable"} $processing_system7_0
    ...
    make_bd_pins_external -name "rt_clk" [get_bd_pins processing_system7_0/FCLK_CLK1]
