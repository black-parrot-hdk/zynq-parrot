...
proc vivado_create_ip { args } {
    ...
    create_bd_port -dir O -type clk ds_clk
    ...
    connect_bd_net [get_bd_port ds_clk] [get_bd_pins clk_wiz_0/clk_out2]
    connect_bd_net [get_bd_port rt_clk] [get_bd_pins clk_wiz_0/clk_out3]
