...
proc vivado_create_ip { args } {
    ...
    lappend file_list "${BP_SUB_DIR}/zynq/v/bsg_axil_debug.sv"

    lappend file_list "${BP_SUB_DIR}/import/riscv-dbg/src/dm_pkg.sv"
    lappend file_list "${BP_SUB_DIR}/import/riscv-dbg/src/dm_top.sv"
    lappend file_list "${BP_SUB_DIR}/import/riscv-dbg/src/dm_csrs.sv"
    lappend file_list "${BP_SUB_DIR}/import/riscv-dbg/src/dm_mem.sv"
    lappend file_list "${BP_SUB_DIR}/import/riscv-dbg/src/dm_sba.sv"

    add_files -norecurse ${file_list}
    set_property file_type SystemVerilog [get_files ${file_list}]
    add_files -norecurse "${BP_SUB_DIR}/zynq/v/debug_top.v"
