...
`timescale 1 ns / 1 ps
    ...
    (
        ...
        input wire [C_GP0_AXI_ID_WIDTH-1 : 0] s00_axi_awid,
        ...
        input wire [C_GP0_AXI_AWUSER_WIDTH-1 : 0] s00_axi_awuser,
        input wire  s00_axi_awvalid,
        output wire  s00_axi_awready,
        input wire [C_GP0_AXI_DATA_WIDTH-1 : 0] s00_axi_wdata,
        input wire [(C_GP0_AXI_DATA_WIDTH/8)-1 : 0] s00_axi_wstrb,
        input wire  s00_axi_wlast,
        input wire [C_GP0_AXI_WUSER_WIDTH-1 : 0] s00_axi_wuser,
        input wire  s00_axi_wvalid,
        output wire  s00_axi_wready,
        output wire [C_GP0_AXI_ID_WIDTH-1 : 0] s00_axi_bid,
        output wire [1 : 0] s00_axi_bresp,
        output wire [C_GP0_AXI_BUSER_WIDTH-1 : 0] s00_axi_buser,
        output wire  s00_axi_bvalid,
        input wire  s00_axi_bready,
        input wire [C_GP0_AXI_ID_WIDTH-1 : 0] s00_axi_arid,
        ...
        input wire [C_GP0_AXI_ARUSER_WIDTH-1 : 0] s00_axi_aruser,
        input wire  s00_axi_arvalid,
        output wire  s00_axi_arready,
        output wire [C_GP0_AXI_ID_WIDTH-1 : 0] s00_axi_rid,
        output wire [C_GP0_AXI_DATA_WIDTH-1 : 0] s00_axi_rdata,
        output wire [1 : 0] s00_axi_rresp,
        output wire  s00_axi_rlast,
        output wire [C_GP0_AXI_RUSER_WIDTH-1 : 0] s00_axi_ruser,
        output wire  s00_axi_rvalid,
        input wire  s00_axi_rready
    );
// Instantiation of Axi Bus Interface S00_AXI
    top_zynq # (
        .C_S_AXI_ID_WIDTH(C_GP0_AXI_ID_WIDTH),
        .C_S_AXI_DATA_WIDTH(C_GP0_AXI_DATA_WIDTH),
        .C_S_AXI_ADDR_WIDTH(C_GP0_AXI_ADDR_WIDTH),
        .C_S_AXI_AWUSER_WIDTH(C_GP0_AXI_AWUSER_WIDTH),
        .C_S_AXI_ARUSER_WIDTH(C_GP0_AXI_ARUSER_WIDTH),
        .C_S_AXI_WUSER_WIDTH(C_GP0_AXI_WUSER_WIDTH),
        .C_S_AXI_RUSER_WIDTH(C_GP0_AXI_RUSER_WIDTH),
        .C_S_AXI_BUSER_WIDTH(C_GP0_AXI_BUSER_WIDTH),
        .C_S_AXI_PROTOCOL(C_GP0_AXI_PROTOCOL)
