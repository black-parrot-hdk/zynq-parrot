...
proc vivado_create_ip { args } {
	...
	set_property CONFIG.PROTOCOL {AXI3} [get_bd_intf_ports gp0_axi]

	connect_bd_net [get_bd_pins top/gp0_axi_aclk] [get_bd_ports aclk]
	connect_bd_net [get_bd_pins top/gp0_axi_aresetn] [get_bd_ports aresetn]
}
