...
inline void send_mc_response_packet(bsg_zynq_pl *zpl,
                                    hb_mc_response_packet_t *packet) {
    int axil_len = sizeof(hb_mc_response_packet_t) / 4;
...
void configure_blackparrot(bsg_zynq_pl *zpl) {
    ...
    send_mc_write(zpl, bp_x_tile, bp_y_tile, bp_bridge_reg_dram_offset,
                  0x2000000);
    send_mc_write(zpl, bp_x_tile, bp_y_tile, bp_bridge_reg_dram_pod,
                  bp_dram_pod_cord);
    send_mc_write(zpl, bp_x_tile, bp_y_tile, bp_bridge_reg_my_cord, 0);
    send_mc_write(zpl, bp_x_tile, bp_y_tile, bp_bridge_reg_host_cord,
                  bp_host_cord);
