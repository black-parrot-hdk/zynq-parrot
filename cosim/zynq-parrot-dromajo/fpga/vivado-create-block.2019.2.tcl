...
# some connections already exist at some point, and reconnecting them errors out; comment out appropriately the connection that makes sense
...
connect_bd_intf_net [get_bd_intf_pins smartconnect_2/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
...
apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/zynq_ultra_ps_e_0/pl_clk0 (50 MHz)" }  [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
...
set_property offset 0x500000000 [get_bd_addr_segs {zynq_ultra_ps_e_0/Data/SEG_top_0_reg04}]
