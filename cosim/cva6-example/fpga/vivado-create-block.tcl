set project_name cva6_bd_proj

create_project -force ${project_name} [pwd] -part xc7z020clg400-1
create_bd_design "cva6_bd_1"
update_compile_order -fileset sources_1
open_bd_design ${project_name}.srcs/sources_1/bd/cva6_bd_1/cva6_bd_1.bd}
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins top_0/aclk]
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins smartconnect_2/aclk]
...
connect_bd_intf_net [get_bd_intf_pins smartconnect_2/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
...
set_property range 1G [get_bd_addr_segs {processing_system7_0/Data/SEG_top_0_reg01}]
validate_bd_design

make_wrapper -files [get_files ${project_name}.srcs/sources_1/bd/cva6_bd_1/cva6_bd_1.bd] -top
add_files -norecurse ${project_name}.srcs/sources_1/bd/cva6_bd_1/hdl/cva6_bd_1_wrapper.v
save_bd_design
