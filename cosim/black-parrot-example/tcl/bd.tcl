...
proc vivado_create_ip { args } {
    ...
    make_bd_intf_pins_external [get_bd_intf_pins top/dma_axis] -name "dma_axis"

    set_property CONFIG.ASSOCIATED_BUSIF {s00_axi:s01_axi:s02_axi:m00_axi:m01_axi:dma_axis} [get_bd_ports aclk]
